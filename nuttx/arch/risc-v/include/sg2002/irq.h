...
#else
#define SG2002_IRQ_I2C1_BASE    (SG2002_IRQ_PERI_START + )
#define SG2002_IRQ_I2C3_BASE    (SG2002_IRQ_PERI_START + )
#define SG2002_IRQ_UART1_BASE   (SG2002_IRQ_PERI_START + 31)
#define SG2002_IRQ_UART2_BASE   (SG2002_IRQ_PERI_START + )
#define NR_IRQS                 (SG2002_IRQ_PERI_START + 32)
#endif
