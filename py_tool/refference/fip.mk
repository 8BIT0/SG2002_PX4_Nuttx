...
fip%: export BLCP_2ND_PATH_NUTTX=/home/bit/Desktop/Develop/PX4_sg2002/py_tool/nuttx_1.bin
...
fip-all: fip-dep
	$(print_target)
	${Q}echo "  [GEN] fip.bin"
	${Q}echo "  [ 8B!T0 ] " $$(ls -l ${BLCP_2ND_PATH_NUTTX})
